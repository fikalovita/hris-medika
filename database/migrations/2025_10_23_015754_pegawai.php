...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pegawai', function (Blueprint $table) {
            ...
            $table->string('usia');
            $table->string('kd_kelompok_umur', 5);
            $table->text('alamat_utama');
            $table->text('alamat_kedua');
            $table->string('kd_kelurahan', 5);
            $table->string('kd_kecamatan', 5);
            $table->string('kd_kabupaten', 5);
            $table->string('kd_provinsi', 5);
            ...
            $table->string('kd_perusahaan', 5);
            $table->string('kd_bidang', 5);
            $table->date('tgl_pengangkatan');
            $table->string('kd_posisi', 5);
            $table->string('kd_lvl_manager', 5);
            $table->string('kd_gol_pekerjaan', 5);
            $table->string('kd_kelompok_gol_pekerjaan', 5);
            $table->string('kd_jns_pekerjaan', 5);
            $table->string('kd_jns_karyawan', 5);
            $table->string('kd_manager', 5);
